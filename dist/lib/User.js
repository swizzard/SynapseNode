...
const { addUserKyc, deleteExistingDocument, updateUser, getUserDuplicates, swapDuplicateUsers, _grabRefreshToken, _oauthUser, createNode, verifyAchMfa, getAllUserNodes, getNode, getUserTransactions, triggerDummyTransactions, generateUboForm, getStatementsByUser, getStatementsByNode, shipCardNode, resetCardNode, verifyMicroDeposits, reinitiateMicroDeposits, updateNode, deleteNode, generateApplePayToken, createTransaction, getTransaction, getAllNodeTransactions, deleteTransaction, commentOnStatus, disputeCardTransaction, getAllSubnets, getSubnet, createSubnet, updateSubnet, pushToMobileWallet, shipCard, registerNewFingerprint, supplyDevice2FA, verifyFingerprint2FA, getUser, updateIpAddress, createBatchTransactions, getAllCardShipments, getCardShipment, deleteCardShipment } = require('../constants/apiReqNames');
...
class User {
    ...
    registerNewFingerprint(fp) {
        return __awaiter(this, void 0, void 0, function* () {
            const refresh_token = yield this._grabRefreshToken();
            this.fingerprint = fp;
            this.headers = buildHeaders({
                client_id: this.client.client_id,
                client_secret: this.client.client_secret,
    ...
    verifyFingerprint2FA(fp, validation_pin) {
        return __awaiter(this, void 0, void 0, function* () {
            const refresh_token = yield this._grabRefreshToken();
            this.fingerprint = fp;
            this.headers = buildHeaders({
