...
const { createUser, getAllUsers, getUser, getPlatformTransactions, getPlatformNodes, getInstitutions, issuePublicKey, createSubscription, getAllSubscriptions, getSubscription, updateSubscription, locateAtms, getCryptoQuotes, getCryptoMarketData, getWebhookLogs, getTradeMarketData, verifyAddress, verifyRoutingNumber } = require('../constants/apiReqNames');
...
module.exports[getAllUsers] = ({ query, page, per_page, show_refresh_tokens, clientInfo }) => {
