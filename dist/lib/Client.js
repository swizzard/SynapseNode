...
const { createUser, getAllUsers, getUser, getPlatformTransactions, getUserTransactions, getPlatformNodes, getInstitutions, issuePublicKey, createSubscription, getAllSubscriptions, getSubscription, updateSubscription, locateAtms, getCryptoQuotes, getCryptoMarketData, getWebhookLogs, getTradeMarketData, verifyAddress, verifyRoutingNumber } = require('../constants/apiReqNames');
...
class Client {
    ...
    // POST CREATE USER
    createUser(bodyParams, ip_address, options = null) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { data } = yield apiRequests.client[createUser]({
                bodyParams,
                headers,
                clientInfo: this
            });
    ...
    getUser(user_id, options = null) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const headers = buildHeaders(headerObj);
            const { data } = yield apiRequests.client[getUser]({
                user_id,
